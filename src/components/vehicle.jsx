      ...
      <div className="vehiclesBody">
        ...
        <div className="vehiclesContanerInfo">
          <div className="vehiclesContainerButtons">
            <button className= {`${vehicle==="LAUNCH" ? "buttonVehiclesActiv" : "buttonVehiclesInactiv"}`} onClick={handleVehicleLaunch}>1</button>
            <button className= {`${vehicle==="SPACEPORT" ? "buttonVehiclesActiv" : "buttonVehiclesInactiv"}`} onClick={handleVehicleSpacePort}>2</button>
            <button className={`${vehicle==="SPACECAPSULE" ? "buttonVehiclesActiv" : "buttonVehiclesInactiv"}`} onClick={handleVehicleSpaceCapsule}>3</button>
          </div>
